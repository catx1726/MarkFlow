...
A: 不会。系统内置多层恢复机制，即使页面内容变动也能找回标记。

**Q: 数据存储在哪里？**  
A: 100% 本地存储，无需注册，不采集任何数据。

**Q: 可以导出笔记吗？**  
A: 支持一键导出 Markdown，可直接粘贴到 Obsidian/Notion。

**Q: 为什么偶尔会弹出确认恢复的弹窗？**  
A: 当网页内容发生大段删减或布局重构时，系统会请求一次手动确认。确认后系统即学习新结构，后续无感恢复。

---

## 技术细节

对恢复算法和工程实现感兴趣？→ [技术文档](./docs/TECHNICAL.md)
