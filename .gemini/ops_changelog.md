...
| 2026-08-21 12:00:00 | Two-level sticky fixes: header top-4 + page-section sticky | src/sidepanel/** | Header sticks at initial position (no 16px drift); page headers pin under folder row via measured --folder-row-h var; z-index stack 40/30/20 | HEAD | git revert HEAD |
