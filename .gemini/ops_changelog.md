...
| 2026-07-29 10:23:00 | Finalize v0.7.3 release: docs, version bump, and changelog | package.json, docs/index.html, CHANGELOG.md, docs/RELEASE_v0.7.3.md, .gemini/ops_changelog.md | Mark v0.7.3 as released on 2026-07-29; bump version to 0.7.3; move PR #59 entry from Unreleased to Released section | HEAD | git revert HEAD |
