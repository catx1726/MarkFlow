        ...
        >
          ...
          <div class="flex flex-wrap gap-1 max-h-[72px] overflow-y-auto custom-scrollbar">
            <button
              ...
              :key="tag.id"
              class="text-[12px] px-2 py-0.5 rounded-full border transition-all duration-200"
              :class="
          ...
          <div class="flex gap-1 mt-1.5">
            ...
            >
            <button
              class="px-2 py-1 text-[12px] rounded hover:opacity-90 disabled:opacity-50 transition-colors"
