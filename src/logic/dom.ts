...
export const calculateSimilarity = TextAnalyzer.calculateSimilarity.bind(TextAnalyzer)
/** @deprecated Use DOMScanner.querySelectorDeep */
export const querySelectorDeep = DOMScanner.querySelectorDeep.bind(DOMScanner)
/** @deprecated Use DOMScanner.querySelectorAllDeep */
export const querySelectorAllDeep = DOMScanner.querySelectorAllDeep.bind(DOMScanner)
/** @deprecated Use DOMScanner.getAllTextNodes */
export const getAllTextNodes = DOMScanner.getAllTextNodes.bind(DOMScanner)
/** @deprecated Use DOMSelector.getElementSelector */
export const getElementSelector = DOMSelector.getElementSelector.bind(DOMSelector)
/** @deprecated Use DOMSelector.findCommonAncestor */
export const findCommonAncestor = DOMSelector.findCommonAncestor.bind(DOMSelector)
/** @deprecated Use DOMSelector.getMarkIdFromElement */
export const getMarkIdFromElement = DOMSelector.getMarkIdFromElement.bind(DOMSelector)
/** @deprecated Use Highlighter.applyPreciseHighlight */
export const applyPreciseHighlight = Highlighter.applyPreciseHighlight.bind(Highlighter)
/** @deprecated Use Highlighter.stripHighlights */
export const stripHighlights = Highlighter.stripHighlights.bind(Highlighter)
/** @deprecated Use Highlighter.getHighlightContext */
export const getHighlightContext = Highlighter.getHighlightContext.bind(Highlighter)
/** @deprecated Use Highlighter.getMaxZIndex */
export const getMaxZIndex = Highlighter.getMaxZIndex.bind(Highlighter)
/** @deprecated Use URLNormalizer.getCanonicalUrl */
export const getCanonicalUrlForMark = URLNormalizer.getCanonicalUrl.bind(URLNormalizer)
