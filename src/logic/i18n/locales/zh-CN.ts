...
export const zhCN = {
  ...
  options: {
    ...
    languageEn: 'English',
    themeLabel: '界面主题',
    themeDesc: '选择扩展界面的明暗主题。「跟随系统」将使用操作系统的主题设置。',
    themeAuto: '跟随系统',
    themeLight: '浅色',
    themeDark: '深色',
    saveSettings: '保存设置',
    ...
    welcomeShortcutSavePrefix: '高亮工具栏打开时按 ',
    welcomeShortcutSaveSuffix: ' 直接保存标记',
    welcomeShortcutDeletePrefix: '点击已有标记打开工具栏，按 ',
    welcomeShortcutDeleteSuffix: ' 删除该标记',
    welcomeShortcutsCustom: '以上快捷键可在下方「快捷键设置」中自定义。',
    thanksTitle: '致谢与支持',
