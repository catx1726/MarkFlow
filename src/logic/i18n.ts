  ...
  zh: {
    sync: {
      ...
      helpContent: `
        <div class="space-y-4">
          <section>
            <h4 class="font-bold text-amber-600 dark:text-amber-400 mb-1">🔑 Token 即身份</h4>
            <p>同步功能完全依赖您生成的 GitHub Personal Access Token。插件<b>不会</b>上传您的 Token 到任何服务器，仅加密存储在当前浏览器本地。</p>
          </section>
          
          <section>
            <h4 class="font-bold text-amber-600 dark:text-amber-400 mb-1">💾 请妥善备份 Token</h4>
          ...
          <section>
            <h4 class="font-bold text-amber-600 dark:text-amber-400 mb-1">🌐 多端同步原理</h4>
            <p>当您在第二个浏览器安装 MarkFlow 时，只需填入相同的 Token，插件会自动通过 Token 找到云端的 Gist 数据并进行合并。</p>
          </section>

          <section>
            <h4 class="font-bold text-amber-600 dark:text-amber-400 mb-1">🔒 数据隐私</h4>
            <p>您的数据存储在您账号下的 <b>Secret Gist</b>（私有代码片段）中，只有持有该 Token 的人可以访问。</p>
          </section>

          <section>
            <h4 class="font-bold text-amber-600 dark:text-amber-400 mb-1">📊 存储上限与健康</h4>
