  ...
  >
    ...
    >
      ...
      <PageSection
        ...
        @toggle-url-collapse="url => emit('toggle-url-collapse', url)"
        @toggle-url-menu="url => emit('toggle-url-menu', url)"
        @export-markdown="data => emit('export-markdown', data)"
        @open-tag-picker="url => emit('open-tag-picker', url)"
        @remove-all-marks="url => emit('remove-all-marks', url)"
        @toggle-group="(url, title, total) => emit('toggle-group', url, title, total)"
        @toggle-group-menu="(url, title) => emit('toggle-group-menu', url, title)"
        @export-group="(url, group) => emit('export-group', url, group)"
        @open-group-tag-picker="(url, title) => emit('open-group-tag-picker', url, title)"
        @remove-group-marks="(url, group) => emit('remove-group-marks', url, group)"
        ...
        @open-mark-tag-picker="(url, id) => emit('open-mark-tag-picker', url, id)"
      />
    </div>
  </details>
</template>
